...
function ProfileTweet(props) {
    ...
    return(
        <div className="proftweet-box">
            
            <div className="profimag-cla">
            <img src= {props.data.authorImg} alt=""/>
            </div>
    
            <div className='profcontent-box'>
            ...
            <svg fill="cornflowerblue" width="17px" height="17px" viewBox="0 0 24 24" aria-label="Verified account" role="img"
             class="r-1cvl2hr r-4qtqp9 r-yyyyoo r-1xvli5t r-9cviqr r-f9ja8p r-og9te1 r-bnwqim r-1plcrui r-lrvibr"><g>
                ...
                &nbsp;
            <span className='proftweet-hour'>{props.data.handle}</span>
            &nbsp;
            <span>. 22h </span>
            </div>
            <div className='proftweet-text'>
                {props.data.text}
            </div>
            <div className='proftweet-footer'>
                <div>
                <svg width="18px"
                height="18px" 
